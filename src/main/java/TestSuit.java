...
public class TestSuit {
    ...
    static String expectedCommunityUserPollVoteMsg = "Error massage is disappear";
    static String expectedCompareProductmsg = "Can not Compare there product";
    static String expectedEmailToFriendmsg = "Can send email to friend";
    static String expectedVoteUserMsg = "Total vote are 9";
    static String expectedReferProductMessage="Successfully message send";
    ...
    public static void verifyUserShouldBeAbbleToRegisterSuccessFully() {
        ...
        // type password
        typeText(By.id("Password"), "test0");
        // type confirm password
        typeText(By.id("ConfirmPassword"), "test0");
    ...
    public static void VerifyUserShouldEmailFriend() {
        ...
        //type friends email
        typeText(By.className("friend-email"), "testemail+" + timestamp.getTime() + "@gmail.com");
        //type your email
        typeText(By.id("YourEmailAddress"), "testemail" + timestamp.getTime() + "@gmail.com");
        ...
        System.out.println("My Message:" + actualMessage);
        Assert.assertEquals(expectedEmailToFriendmsg, "Can not sending email to friend");
    }
    ...
    public static void verifyUserShouldBeAbbleToVoteSuccesfully() {
        ...
        typeText(By.id("Email"), "Jahanve@gmail.co.uk");
        //click on password and filled it
        typeText(By.id("Password"), "AB1");
        typeText(By.id("ConfirmPassword"), "AB1");
        clickOnElement(By.id("register-button"));
        //click on login
        clickOnElement(By.className("ico-login"));
        //click on email
        typeText(By.id("Email"), "Vaidehi@gamil.co.uk");
        //type password
        typeText(By.id("Password"), "CD1");
        //click on login
        ...
        System.out.println("My message" + actualMessage);
        Assert.assertEquals(expectedVoteUserMsg, "Total vote are wrong");
    }
    @Test
